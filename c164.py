...
label_img_planet=Label(root,bg="gold2",highlightthickness=5,borderwidth=2,relief=SOLID)
label_planet_gravity_radius=Label(root,font=("castellar"),bg="lightblue")
label_planet_info=Label(root,font=("courier",10,"bold"),bg="lightblue",wraplength=200)
...
btn=Button(root,text="Show Planet Info",command=showPlanetInfo)
...
label_img_planet.place(relx=0.5,rely=0.5,anchor=CENTER)
